...
import { getSiteSettings, getContactInfo } from "@/lib/sanity/queries";
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">{merkez.phone}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">{merkez.email}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">{merkez.address[locale as Locale]}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">{t("contact.phone")}</p>
                      <p className="text-gray-600">{sube.phone}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">{t("contact.email")}</p>
                      <p className="text-gray-600">{sube.email}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">{t("contact.address")}</p>
                      <p className="text-gray-600">{sube.address[locale as Locale]}</p>
                    </div>
                  </div>
                </div>
              </div>
