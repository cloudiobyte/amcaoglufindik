...
import { getSecondHandEquipment, getSiteSettings } from "@/lib/sanity/queries";
...
export default async function SecondHandEquipmentPage({
  ...
  const backgroundImage = siteSettings?.secondHandEquipmentPageBackground 
    ? urlFor(siteSettings.secondHandEquipmentPageBackground).width(1920).quality(90).url()
    : null;
